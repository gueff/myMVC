...
class DTDataTypeGeneratorConfig
{
	...
	/**
	 * @var \MVC\DataType\DTDataTypeGeneratorClass[]
	 */
    ...
    /**
     * @param \MVC\DataType\DTDataTypeGeneratorClass $oDTClass
     * @return $this
     */
    public function add_DTClass(\MVC\DataType\DTDataTypeGeneratorClass $oDTClass)
    {
        $this->class[] = $oDTClass;
	...
	/**
	 * @param \MVC\DataType\DTDataTypeGeneratorClass $mValue 
	 * @return $this
	 */
	public function set_class(\MVC\DataType\DTDataTypeGeneratorClass $mValue)
	{
		$this->class = $mValue;
	...
	/**
	 * @return \MVC\DataType\DTDataTypeGeneratorClass[]
	 */
