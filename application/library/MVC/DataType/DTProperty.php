...
class DTProperty
{
	...
	{
		\MVC\Event::RUN ('DTProperty.set_key.before', \MVC\DataType\DTArrayObject::create(array('key' => $mValue))->add_aKeyValue(\MVC\DataType\DTKeyValue::create()->set_sKey('aBacktrace')->set_sValue(\MVC\Debug::prepareBacktraceArray(debug_backtrace()))));
	...
	{
		\MVC\Event::RUN ('DTProperty.set_var.before', \MVC\DataType\DTArrayObject::create(array('var' => $mValue))->add_aKeyValue(\MVC\DataType\DTKeyValue::create()->set_sKey('aBacktrace')->set_sValue(\MVC\Debug::prepareBacktraceArray(debug_backtrace()))));
	...
	{
		\MVC\Event::RUN ('DTProperty.set_visibility.before', \MVC\DataType\DTArrayObject::create(array('visibility' => $mValue))->add_aKeyValue(\MVC\DataType\DTKeyValue::create()->set_sKey('aBacktrace')->set_sValue(\MVC\Debug::prepareBacktraceArray(debug_backtrace()))));
	...
	{
		\MVC\Event::RUN ('DTProperty.set_static.before', \MVC\DataType\DTArrayObject::create(array('static' => $mValue))->add_aKeyValue(\MVC\DataType\DTKeyValue::create()->set_sKey('aBacktrace')->set_sValue(\MVC\Debug::prepareBacktraceArray(debug_backtrace()))));
	...
	{
		\MVC\Event::RUN ('DTProperty.set_setter.before', \MVC\DataType\DTArrayObject::create(array('setter' => $mValue))->add_aKeyValue(\MVC\DataType\DTKeyValue::create()->set_sKey('aBacktrace')->set_sValue(\MVC\Debug::prepareBacktraceArray(debug_backtrace()))));
	...
	{
		\MVC\Event::RUN ('DTProperty.set_getter.before', \MVC\DataType\DTArrayObject::create(array('getter' => $mValue))->add_aKeyValue(\MVC\DataType\DTKeyValue::create()->set_sKey('aBacktrace')->set_sValue(\MVC\Debug::prepareBacktraceArray(debug_backtrace()))));
	...
	{
		\MVC\Event::RUN ('DTProperty.set_explicitMethodForValue.before', \MVC\DataType\DTArrayObject::create(array('explicitMethodForValue' => $mValue))->add_aKeyValue(\MVC\DataType\DTKeyValue::create()->set_sKey('aBacktrace')->set_sValue(\MVC\Debug::prepareBacktraceArray(debug_backtrace()))));
	...
	{
		\MVC\Event::RUN ('DTProperty.set_listProperty.before', \MVC\DataType\DTArrayObject::create(array('listProperty' => $mValue))->add_aKeyValue(\MVC\DataType\DTKeyValue::create()->set_sKey('aBacktrace')->set_sValue(\MVC\Debug::prepareBacktraceArray(debug_backtrace()))));
	...
	{
		\MVC\Event::RUN ('DTProperty.set_createStaticPropertyGetter.before', \MVC\DataType\DTArrayObject::create(array('createStaticPropertyGetter' => $mValue))->add_aKeyValue(\MVC\DataType\DTKeyValue::create()->set_sKey('aBacktrace')->set_sValue(\MVC\Debug::prepareBacktraceArray(debug_backtrace()))));
	...
	{
		\MVC\Event::RUN ('DTProperty.set_setValueInConstructor.before', \MVC\DataType\DTArrayObject::create(array('setValueInConstructor' => $mValue))->add_aKeyValue(\MVC\DataType\DTKeyValue::create()->set_sKey('aBacktrace')->set_sValue(\MVC\Debug::prepareBacktraceArray(debug_backtrace()))));
	...
	{
		\MVC\Event::RUN ('DTProperty.set_forceCasting.before', \MVC\DataType\DTArrayObject::create(array('forceCasting' => $mValue))->add_aKeyValue(\MVC\DataType\DTKeyValue::create()->set_sKey('aBacktrace')->set_sValue(\MVC\Debug::prepareBacktraceArray(debug_backtrace()))));
	...
	{
		\MVC\Event::RUN ('DTProperty.set_addMyMVCEvents.before', \MVC\DataType\DTArrayObject::create(array('addMyMVCEvents' => $mValue))->add_aKeyValue(\MVC\DataType\DTKeyValue::create()->set_sKey('aBacktrace')->set_sValue(\MVC\Debug::prepareBacktraceArray(debug_backtrace()))));
